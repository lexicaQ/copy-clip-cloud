...
const FeatureCallToAction = () => {
  ...
  return <motion.div className="mt-32 text-center relative" variants={containerVariants} initial="hidden" whileInView="visible" viewport={{
    once: true
  }}>
      ...
      <motion.div className="absolute left-1/2 bottom-0 transform -translate-x-1/2 translate-y-16 opacity-30" animate={{
      y: [0, 8, 0],
      opacity: [0.3, 0.6, 0.3]
    }} transition={{
      duration: 2,
