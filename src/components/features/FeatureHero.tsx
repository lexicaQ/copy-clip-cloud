  ...
  return (
    ...
    >
      <div className="absolute inset-0 -z-10 flex items-center justify-center">
        <div className="w-[400px] h-[400px] rounded-full bg-white/5 blur-[100px] opacity-50"></div>
      </div>
      
      <motion.div 
        className="h-20 w-20 rounded-2xl glass-panel flex items-center justify-center mx-auto mb-8 relative" 
      ...
      <motion.p 
        className="text-xl text-gray-400 max-w-xl mx-auto leading-relaxed" 
        initial={{ opacity: 0, y: 20 }} 
        animate={{ opacity: 1, y: 0 }} 
      ...
      >
        {["AI-Powered", "End-to-End Encryption", "Cloud Sync", "Privacy First", "Intelligent Search"].map((tag, index) => (
          <motion.span 
            key={index} 
